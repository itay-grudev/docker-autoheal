...
- [`latest` (*Dockerfile*)](/Dockerfile) - Built weekly from the latest Alpine Linux image after testing
...
docker run -d \
    ...
    ghcr.io/itay-grudev/docker-autoheal:latest
```
#### TCP socket 
```bash
docker run -d \
...
services:
  ...
  autoheal:
    ...
    image: ghcr.io/itay-grudev/docker-autoheal:latest
    network_mode: none
    restart: always
    volumes:
